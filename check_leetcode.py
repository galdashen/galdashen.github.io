...
DEFAULT_REQUIRED_KEYWORDS = [
    ...
    "时间复杂度：",
    "空间复杂度：",
    "/description/?envType=study-plan-v2&envId=top-100-liked",
    "$",
]
DEFAULT_ANY_OF_KEYWORDS = ["### 解法", "### 方法二"]
...
def main() -> int:
    ...
    parser.add_argument(
        "--folders",
        nargs="+",
        default=["leetcode-hot-100"],
        help="需要检查的子目录名，默认检查 leetcode-hot-100",
    )
    parser.add_argument(
        "--required-keywords",
        nargs="+",
    ...
    print(
        "除此以外还要检查 1. 题目描述是否精简 2. 不同解法是否考虑 3. 解法思路分析是否简洁明了 4. 复杂度是否正确"
    )
