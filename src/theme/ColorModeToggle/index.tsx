...
type Props = React.ComponentProps<typeof OriginalColorModeToggle>;
...
export default function ColorModeToggle(props: Props): React.JSX.Element {
  ...
  return (
    <div className="color-mode-with-theme-toggle">
      <OriginalColorModeToggle {...props} />
      <button
        type="button"
        className={clsx("clean-btn", "mobile-color-theme-toggle")}
        onClick={handleClick}
