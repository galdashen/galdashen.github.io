...
const FeatureList: FeatureItem[] = [
  ...
  {
    title: "生物学",
    Svg: require("@site/static/img/subject-biology.svg").default,
    description: (
      <>
        生物学是探索生命现象和生命活动规律的科学，是自然科学中的一门基础学科。其研究对象是生物（包括植物、动物和微生物）的结构、功能、发生和发展规律。其目的在于阐明和控制生命活动，改造自然，为农业、工业和医学等实践服务。
      </>
    ),
  },
];
